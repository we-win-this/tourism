...
> 한국관광공사 OpenAPI — 중문번체(繁體中文) 관광정보 서비스 v4.4

---

## 개요

**중국어 번체(繁體中文)** 로 제공되는 전국 관광정보 서비스. 대만·홍콩·마카오 등 번체 사용 중화권 사용자 대상.

---

## API 명세

**Base URL**: `https://apis.data.go.kr/B551011/ChtService1/`

국문 API(`KorService1`)와 동일한 오퍼레이션 구조를 사용하며, 응답 데이터가 중국어 번체로 제공된다.
...
| 파일명 | 설명 |
|--------|------|
| `한국관광공사_개방데이터_활용매뉴얼(중문번체)_v4.4.docx` | 전체 API 명세 및 예제 |
