...
> 한국관광공사 OpenAPI — 서어(Español) 관광정보 서비스 v4.3

---

## 개요

**스페인어(Español)** 로 제공되는 전국 관광정보 서비스.

---

## API 명세

**Base URL**: `https://apis.data.go.kr/B551011/SpaService1/`

국문 API(`KorService1`)와 동일한 오퍼레이션 구조를 사용하며, 응답 데이터가 스페인어로 제공된다.
...
| 파일명 | 설명 |
|--------|------|
| `한국관광공사_개방데이터_활용매뉴얼(서어)_v4.3.docx` | 전체 API 명세 및 예제 |
